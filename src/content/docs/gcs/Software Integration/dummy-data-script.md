...
5. You should see each that vehicles's telemetry queue is receiving the dummy telemetry data as shown below. If you ran the GCS application, the data should be displayed on the UI.
